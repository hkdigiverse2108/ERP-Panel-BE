    ...
    return new Promise(async (resolve, reject) => {
        try {
            const mailOptions = {
                ...
                subject: "AI Setu - Email Verification",
                html: `<html lang="en-US">
    
                <head>
                    <meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
                    <title>AI Setu - Email Verification</title>
                    <meta name="description" content="Email Verification for AI Setu.">
                    <style type="text/css">
                        a:hover {
                                                ...
                                                <tr>
                                                    <td style="padding:0 35px;">
                                                        ...
                                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                                            ...
                                                            <br>
                                                            Welcome to the AI Setu! Please verify your email to continue.
                                                            <br>
